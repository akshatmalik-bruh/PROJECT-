...
function LoginPage() {
  ...
  const formFields = [
    ...
    { label: "Enter Password", placeholder: "Password...", name: "password", type: "password" },
  ];
    ...
    <div className="flex flex-col h-screen w-full md:flex-row">
      ...
      <div className="w-full h-1/2 md:w-[68vw] md:h-full bg-slate-950 text-white flex flex-col items-center justify-center">
        <div className="text-center space-y-4">
          <h1 className="text-2xl lg:text-4xl font-bold">WHY TRAVEL <span className="text-red-400">ALONE ?</span> </h1>
          <h1 className="text-xl lg:text-4xl font-bold">Log In here & <span className="text-green-300"> Find a Company :)</span></h1>
          <h1 className="text-xl lg:text-base p-5">
              NOT A USER? <Link to="/signup" className="underline text-gray-200 hover:text-gray-400">SIGN UP NOW!
            </Link>
          </h1>
        </div>
      </div>
      ...
      <div className="w-full md:w-[32vw] bg-white flex flex-col text-black p-5 md:p-20 gap-5 justify-center items-center">
        <h1 className="text-black text-center xl:text-2xl lg:text-lg sm:text-xs font-bold">LOGIN</h1>
        <form
