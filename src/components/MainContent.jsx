    ...
    {[{
        ...
        return (
            <div key={index} className ="flex flex-col gap-10 ">
                <label htmlFor={data.ref} className ="text-2xl text-center">{data.label}</label>
                <input type="text" placeholder={data.placeholder} id={data.ref} name={data.ref} className ="p-5 bg-slate-200 w-full rounded-xl "/>
            </div>
        );
    })}
    <button type="submit" className ="text-xl bg-black text-white p-3 rounded-xl w-fit ">Submit</button>
</form>
